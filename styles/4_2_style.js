...
var style_4_2 = function(feature, resolution){
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("temprture");
        if (feature.get("The station") !== null) {
            labelText = String(feature.get("The station"));
        }
    ...
    if (value >= 12.000000 && value <= 25.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25.400000 && value <= 28.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 28.800000 && value <= 30.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.600000 && value <= 35.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 35.600000 && value <= 42.000000) {
            style = [ new ol.style.Style({
